...
<body>  <%-- <c:choose>태그 사용하기 --%>
	...
	<form> <!-- 점수 입력 폼 : method값이 생략되면 기본적으로 'get' / action값이 생략되면 기본적으로 '현재 주소창의 uri값'-->
		국어:<input type="text" id="kor" name="kor" /><br />
		영어:<input type="text" id="kor" name="eng" /><br />
		수학:<input type="text" id="kor" name="math" /><br />
